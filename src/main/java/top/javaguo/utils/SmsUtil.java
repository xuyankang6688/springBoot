...
public class SmsUtil {
	...
	static final String accessKeyId = "LTAI4Ffke5Py5KxdNVFEB9Uu";// yourAccessKeyId
	static final String accessKeySecret = "QnvI82BWRXEo1wd6wsHRmImCVjgwRb";// yourAccessKeySecret
	...
	public static SendSmsResponse sendSms(String PhoneNumbers, String TemplateCode, String TemplateParam)
		...
		// 必填:待发送手机号
		request.setPhoneNumbers(PhoneNumbers);// "15000000000"
		// 必填:短信签名-可在短信控制台中找到
		request.setSignName("上海仓穗烘焙");// "云通信"
		// 必填:短信模板-可在短信控制台中找到
		request.setTemplateCode(TemplateCode);// "SMS_1000000"
...
//		// 发短信
//		SendSmsResponse response = sendSms("15658118505", "SMS_160545243", "{\"code\":\"123456\"}");// ""
