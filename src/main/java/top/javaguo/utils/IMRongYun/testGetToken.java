...
public class testGetToken {
    ...
    private static final String[] targetIds = {"330868648036143104"};

    @Before
    public void setUp() throws Exception {
        System.out.println("jinru fanfazhiqian===");
        String appKey = "c9kqb3rdc4iij";
        String appSecret = "KHo1OTQWWVqe";
   ...
   /* *//**
    ...
    public void testSendSystemTemplate() throws Exception {
        ...
        try {
            ...
            reader = new BufferedReader(new InputStreamReader(testGetToken.class.getClassLoader().getResourceAsStream("jsonsource/message/TemplateMessage.json")));
    ...
    public void testSendPrivate() throws Exception {
        ...
        PrivateMessage privateMessage = new PrivateMessage()
                .setSenderId("331295530435088384")
                .setTargetId(targetIds)
                .setObjectName(txtMessage.getType())
                .setContent(txtMessage)
                .setPushContent("")
                .setPushData("{\"pushData\":\"hello11\"}")
                .setCount("4")
    ...
    public void testPush() throws Exception {
        ...
        Audience audience = new Audience();
        audience.setUserid(new String[]{"348730193566896128"});
    ...
    public void getRongToken() {
        ...
        String App_Key = "vnroth0kvbxmo"; //开发者平台分配的 App Key。
        String App_Secret = "xCiVEC95rENq2z";
        ...
        String Signature  = hexSHA1(toSign.toString());//数据签名。
        ...
        nameValuePair.add(new BasicNameValuePair("userId", "11111"));
        nameValuePair.add(new BasicNameValuePair("name","王子"));
        nameValuePair.add(new BasicNameValuePair("portraitUri","http://www.rongcloud.cn/images/logo.png"));
